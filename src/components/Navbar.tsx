...
export default function Navbar() {
  ...
  <div className="relative">
    <img
      ...
      alt="Profile"
      className="w-8 h-8 rounded-full cursor-pointer border-2 border-white dark:border-gray-700"
    ...
    {menuOpen && (
      <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg z-50">
        <ul className="py-1 text-sm text-gray-700 dark:text-gray-200">
          <li>
            <Link href="/profile" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700">My Profile</Link>
          </li>
          <li>
            <button
